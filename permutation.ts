...
const evaluate = (str:string, permutationSet :Array<any>):Array<any> => {
  ...
  return evaluate(str.substring(1), permutationSet);
}

evaluate(input,permutationSet);
console.log(`Result for permutation of ${input} is`);
